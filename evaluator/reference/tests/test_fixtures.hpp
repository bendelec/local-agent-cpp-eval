...
// Minimal shared helpers for the reference-library tests. These helpers use only the
// public API (candidate/include/vwmini/*) and hand-authored literal triangles; they
// never call the triangulator and never reach into implementation internals.
...
/// Sampling is adequate for the well-separated fixtures used by these tests.
