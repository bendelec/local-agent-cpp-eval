...
| `qwen38-flash-q5-kl-run-01` | Qwen 3.8 Flash | Local Lemonade / llama.cpp; Q5_K_L | Current revision: NFR-009 and NFR-010 | **77/77**; independent epsilon-band path/motion tunnelling and speed-cap probes fail | **75/100** | Final after two repairs | [evaluation](qwen38-flash-q5-kl-run-01.md) |
