...
| Non-Functional Requirements | [non-functional.md](non-functional.md) | Build, API compatibility, quality, scope constraints, and architecture documentation. | NFR-001 – NFR-009 |

## Non-Functional Requirements
- NFR-001 through NFR-009 are normative non-functional requirements and constraints.
