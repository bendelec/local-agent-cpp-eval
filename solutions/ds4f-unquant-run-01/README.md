...
`docs/architecture/architecture.md` and `docs/architecture/implementation-plan.md`;
they are intentionally not supplied in this package. Keep both current as the design
evolves.
