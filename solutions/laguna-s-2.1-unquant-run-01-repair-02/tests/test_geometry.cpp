...
{
    const std::vector<vwmini::Vec2> square = {{0, 0}, {2, 0}, {2, 2}, {0, 2}};
...
{
    const std::vector<vwmini::Vec2> shape = {{0, 0}, {4, 0}, {4, 3}, {2, 2}, {0, 3}};
...
{
    const std::vector<vwmini::Vec2> pentagon = {{0, 0}, {2, 0}, {3, 1}, {1, 2}, {-1, 1}};
