...
5. **Avoidance = RVO velocity-obstacle projection, single-substep** (SIM-010,
   ...
   Initially overlapping discs are pushed apart along the centre line with a
   deterministic anti-symmetric fallback (smaller slot id pushes +x).
