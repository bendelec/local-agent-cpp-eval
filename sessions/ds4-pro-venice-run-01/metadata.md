...
> Populate the exact Venice catalog model id, request configuration, completion artifact, and
> source archive after the run. Do not record credentials or absolute local paths.

| Field | Value |
|---|---|
| Model | DeepSeek V4 Pro |
| Runtime | Venice API; exact catalog model identifier pending. |
