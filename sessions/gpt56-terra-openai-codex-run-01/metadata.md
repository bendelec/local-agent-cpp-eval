...
> Populate exact API model id, request configuration, completion artifact, and source archive
> after the run. Do not record credentials or absolute local paths.

| Field | Value |
|---|---|
| Model | GPT-5.6 terra |
| Runtime | OpenAI Codex API; subscription plan. Exact API model identifier pending. |
| Precision | Provider-managed; not applicable/pending. |
...
| Evaluation record | To be created at `../../evaluations/gpt56-terra-openai-codex-run-01.md` after intake. |
